...
class App(tk.Tk):
    ...
    def create_widgets(self):
        ...
        self.url_textbox = tk.Entry(self, width=45)
        ...
        self.path_textbox = tk.Entry(self, width=40)
        ...
        extract_button.grid(row=6, column=0, columnspan=2, sticky='nesw')

        # Create button to extract data
        reset_button = tk.Button(self, text="Reset", command=self.reset, bg="grey70")
        reset_button.grid(row=6, column=2, columnspan=2, sticky='nesw')
    ...
    def extract_data(self):
        ...
        try:
            ...
            #script_path = "./src/main/main.py"
            #subprocess.run(["python", script_path, "--url", self.url, "--output", self.output_path], check=True)
